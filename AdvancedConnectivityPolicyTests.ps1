...
try {
    ...
    if ($Local) {
        ...
        Invoke-WebRequest -Uri $('https://github.com/ShawnXxy/SQL-Connectivity-Checker/xixia/raw/' + $RepositoryBranch + '/netstandard2.0/TDSClient.dll') -OutFile $TDSClientPath -UseBasicParsing
    }
