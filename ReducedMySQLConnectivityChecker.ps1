...
try {
    ...
    Invoke-WebRequest -Uri $('https://github.com/ShawnXxy/SQL-Connectivity-Checker/tree/xixia/raw/' + $RepositoryBranch + '/netstandard2.0/TDSClient.dll') -OutFile $path -UseBasicParsing
